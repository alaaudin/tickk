      ...
      <div className="relative bg-white/10 dark:bg-[#111111]/60 backdrop-blur-3xl rounded-[22px] border border-neutral-200/50 dark:border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.1)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] p-8 lg:p-10 flex flex-col md:flex-row gap-8 lg:gap-12">
        <div className="flex-1 space-y-6">
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-display text-white tracking-tight">System Ready</h2>
          ...
          <div className="space-y-4 pt-2">
            <div className="group relative bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/10 p-4 rounded-xl transition-all duration-300 flex items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-zinc-200">Provision Outbound Node</h4>
                  <p className="text-[11px] text-zinc-500 mt-0.5">Connect your SMTP credentials</p>
                </div>
              </div>
              <button 
                onClick={() => { onNavigate('mail'); toggleStep(1); }}
                className="flex items-center gap-2 px-3 py-1.5 text-[11px] font-mono uppercase tracking-wider font-semibold text-black bg-white hover:bg-zinc-200 rounded-lg transition-colors"
              >
            ...
            <div className="group relative bg-white/5 hover:bg-white/10 border border-white/5 hover:border-white/10 p-4 rounded-xl transition-all duration-300 flex items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-zinc-200">Generate Encryption Key</h4>
                  <p className="text-[11px] text-zinc-500 mt-0.5">Secure your API endpoints</p>
                </div>
              </div>
              <button 
                onClick={() => { onGenerateKey(); toggleStep(2); }}
                className="flex items-center gap-2 px-3 py-1.5 text-[11px] font-mono uppercase tracking-wider font-semibold text-zinc-300 bg-white/10 hover:bg-white/20 border border-white/5 hover:border-white/20 rounded-lg transition-all"
              >
                <Key className="w-3 h-3" /> Generate
              </button>
            </div>

            <div className="group relative bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/5 p-4 rounded-xl transition-all duration-300">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <h4 className="text-sm font-semibold text-zinc-200">Fire Outbound Test Signal</h4>
