...
export function SubscriptionSettingsPanel({ toast }: { toast: (message: string, type: 'success' | 'error') => void }) {
  return (
      ...
      <div className="bg-white/10 dark:bg-[#111111]/60 backdrop-blur-3xl border border-neutral-200/50 dark:border-white/10 rounded-[22px] p-6 shadow-[0_8px_32px_rgba(0,0,0,0.1)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] relative overflow-hidden group">
        ...
        <div className="flex items-center gap-3 mb-6 relative z-10 border-b border-neutral-100 dark:border-zinc-800/50 pb-4">
          ...
          <div>
            ...
            <p className="text-[11px] text-zinc-500 font-sans mt-0.5">You are currently on the Enterprise tier</p>
          </div>
        </div>

        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-neutral-50 dark:bg-zinc-900/30 rounded-xl p-5 border border-neutral-200 dark:border-zinc-800">
            <div className="flex justify-between items-start mb-4">
              <div>
                <h4 className="text-sm font-bold text-neutral-900 dark:text-white font-display uppercase tracking-widest">Enterprise</h4>
            ...
            <button className="w-full py-2 bg-neutral-200 dark:bg-zinc-800 text-neutral-900 dark:text-white text-xs font-semibold rounded-lg hover:bg-neutral-300 dark:hover:bg-zinc-700 transition-colors font-sans">
              Manage Billing
            </button>
          </div>
            ...
            <div className="bg-neutral-50 dark:bg-[#08080a] border border-neutral-200 dark:border-zinc-800 rounded-xl p-5">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs font-mono">
                  <span className="text-zinc-500">Pixels Fired</span>
                  <span className="text-neutral-900 dark:text-white font-semibold">1,245,032</span>
                </div>
                <div className="w-full bg-neutral-200 dark:bg-zinc-800 rounded-full h-1.5">
                  <div className="bg-indigo-500 h-1.5 rounded-full" style={{ width: '45%' }}></div>
                </div>
                <p className="text-[10px] text-zinc-500 font-sans text-right">45% of unlimited capacity</p>
              </div>
            </div>
          </div>
        </div>
