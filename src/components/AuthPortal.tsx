            ...
            {mode === 'verify' ? (
              ...
              <div className="bg-white/40 dark:bg-[#121215]/60 backdrop-blur-2xl border border-neutral-200/50 dark:border-zinc-800/60 rounded-3xl p-8 sm:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.04)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.2)] w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  {/* --- Google Auth Button Section --- */}
                  <div className="w-full space-y-4">
                    <button
                      type="button"
                      onClick={handleGoogleLogin}
                      className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-neutral-50 text-neutral-800 dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:text-neutral-100 font-medium text-sm rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm hover:shadow transition-all duration-200 active:scale-[0.99]"
                    >
                  ...
                  <div className="relative py-2">
                    <div className="absolute inset-0 flex items-center">
                      <div className="w-full border-t border-neutral-200/50 dark:border-zinc-800/60"></div>
                    </div>
                    <div className="relative flex justify-center text-[11px] uppercase tracking-wider font-medium">
                      <span className="px-3 text-neutral-400 bg-[#fafafa] dark:bg-[#161619] rounded-full">Or continue with email</span>
                    </div>
                  </div>
